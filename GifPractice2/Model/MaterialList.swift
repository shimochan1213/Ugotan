...
class MaterialList{
    ...
    init(){
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "resume", japanWordsName: "再開する", correctOrNot: true))
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "monitor", japanWordsName: "監視する", correctOrNot: true))
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "dispatch", japanWordsName: "出荷する", correctOrNot: true))
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "researve", japanWordsName: "予約する", correctOrNot: true))
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "occure", japanWordsName: "起こる", correctOrNot: true))
        TOEIC600verbList.append(MaterialModel(wordsName: "repair", japanWordsName: "修理する", correctOrNot: true))
        ...
        TOEIC600verbList.append(MaterialModel(wordsName: "allow 人 to V", japanWordsName: "人が〜するのを許す", correctOrNot: true))
        ...
        TOEIC600NounList.append(MaterialModel(wordsName: "branch", japanWordsName: "支店", correctOrNot: true))
        ...
        TOEIC600NounList.append(MaterialModel(wordsName: "preparation", japanWordsName: "準備", correctOrNot: true))
        ...
        TOEIC600NounList.append(MaterialModel(wordsName: "replacement", japanWordsName: "取り換え", correctOrNot: true))
        ...
        TOEIC600NounList.append(MaterialModel(wordsName: "import", japanWordsName: "輸出", correctOrNot: true))
        ...
        TOEIC600AdverbList.append(MaterialModel(wordsName: "occasionaly", japanWordsName: "時々", correctOrNot: true))
        ...
        TOEIC600OthersList.append(MaterialModel(wordsName: "in 〜 setting", japanWordsName: "〜な環境で", correctOrNot: true))
